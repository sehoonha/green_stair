...
class StepOffsetMotion(ParameterizedMotion):
    def __init__(self, skel, ref):
        ...
        #      0.3247441420027, -0.0218107775943, 0.074129502408, 0.253947235854,
        #      # 0.13945311051, 0.20092042782, -0.143099631998, 0.100214020591,
        #      -0.507101639726, 0.123078975583, 0.084933699163]
        x = [0.0404008779181, 0.0429821534588, 0.0644400167019, -0.0845854266764,
             0.0763220594409, 0.123318282953, -0.0172537376346, 0.0501128421974,
             0.1561699303186, -0.0611590225684, 0.0834956071055, 0.0084959537572,
             -0.430605689239, 0.0828772169506, 0.115544678731]
        self.set_params(x)
