...
class RadialBasisMotion(ParameterizedMotion):
    def __init__(self, skel, ref, stair):
        ...
        # x0 = [-0.11429011780171319, -0.44721378361028086, -1.2676412062421372,
        ...
        # # Spring stair: 0.2s
        # x1 = [-0.29036564636201589, -0.54382305925350904, -0.97673111171896188,
        ...
        x_all = np.zeros(self.num_params())
        # self.set_params(x0, 0)
        # self.set_params(x1, 1)
        self.set_params(x_all)
